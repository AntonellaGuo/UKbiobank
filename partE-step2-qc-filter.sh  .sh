...
# - /{exome_file_dir}/ukb23155_c1_v2.bed - Chr1 file 
...
for i in {1..22}; do
    run_plink_wes="plink2 --bfile ukb${data_field}_c${i}_v2\
    ...
    dx run swiss-army-knife \
     -iin="${exome_file_dir}/${data_field}_c${i}_v2.bed" \
     -iin="${exome_file_dir}/${data_field}_c${i}_v2.bim" \
     -iin="${exome_file_dir}/${data_field}_c${i}_v2.fam" \
